...
int main()
{
    ...
    productionWorker baub("baub", 20.50, 2);
    ShiftSupervisor Bauwb("bauwb", 202000.22, 489);
    TeamLeader BAAAAAAAAAAAAAAAWWWWWWWWWB("BAAAAAAAAAAAAAAAWWWWWWWWWB", 400000.12, 70, 80);

    bawb.printEmployee(bawb.getName());
